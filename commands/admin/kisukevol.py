...
class KisukeVol(commands.Cog):
    ...
    # 🔹 Commande SLASH
    # ============================================================================
    @app_commands.command(name="kisukevol",description="(Admin) 🌀 Kisuke vole le Reiatsu d'un membre comme un joueur normal.")
    ...
    # 🔹 Commande PREFIX
    # ============================================================================
    @commands.command(name="kisukevol",aliases=["kvol"],help="(Admin) 🌀 Kisuke vole le Reiatsu d'un membre comme un joueur normal.")
