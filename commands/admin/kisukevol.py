...
class KisukeVol(commands.Cog):
    ...
    async def _kisukevol_logic(self, admin: discord.Member, channel: discord.abc.Messageable, guild: discord.Guild):
        try:
            # ✅ Récupère tous les membres ayant du Reiatsu > 0
            ...
            if not membres_db:
                await safe_send(channel, "⚠️ Aucun membre valide trouvé sur le serveur.")
                return
            ...
            # 🎲 Calcul du succès (comme pour un joueur normal)
