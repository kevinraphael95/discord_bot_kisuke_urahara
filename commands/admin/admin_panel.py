...
class AdminPanelCog(commands.Cog):
    ...
    # 🔹 Commande SLASH
    # ============================================================================
    @app_commands.command(name="adminpanel",description="(Admin) Afficher le lien du panneau admin.")
    ...
    # 🔹 Commande PREFIX
    # ============================================================================
    @commands.command(name="adminpanel",help="(Admin) 🔒 Affiche le lien du panneau admin.")
